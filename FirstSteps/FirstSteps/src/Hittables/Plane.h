...
{
public:
	XYPlane(double x0, double x1, double y0, double y1, double k, const Material* material);
...
{
public:
	XZPlane(double x0, double x1, double y0, double y1, double k, const Material* material);
	virtual bool isHit(const Ray& ray, double minT, double maxT, HitRecord& record) const override;
	virtual bool hasBoundingBox(double time0, double time1, AABB& boundingBox) const override;
...
{
public:
	YZPlane(double y0, double y1, double z0, double z1, double k, const Material* material);
	virtual bool isHit(const Ray& ray, double minT, double maxT, HitRecord& record) const override;
	virtual bool hasBoundingBox(double time0, double time1, AABB& boundingBox) const override;
