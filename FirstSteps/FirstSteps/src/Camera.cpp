...
Camera::Camera(const Point3& lookFrom, const Point3& lookAt, const Vector3& vUp, double aspectRatio, double verticalFov, double aperature, double focusDistance)
{
...
Ray Camera::getRay(double s, double t) const
{
    ...
    return Ray(m_Origin + offset, m_UpperLeftCorner + s * m_HorizontalPlane - t * m_VerticalPlane - m_Origin - offset);
}
